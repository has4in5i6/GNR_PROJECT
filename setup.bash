...
# Replace this with your public GitHub repository URL before zipping setup.bash.
REPO_URL="https://github.com/xxxxx/GNR_PROJECT.git"
BRANCH="main"
MODEL_ID="Qwen/Qwen2.5-VL-3B-Instruct"
MODEL_DIR="models/qwen2_5_vl_3b"

if [[ "$REPO_URL" == *xxxxx* ]]; then
...
git remote add origin "https://github.com/has4in5i6/GNR_PROJECT.git"
